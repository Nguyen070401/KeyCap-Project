        ...
        <>
         <Navbar/>
            <div className={styles.contact}>  
                <h2>CÁC CÂU HỎI THƯỜNG GẶP VÀ FORM LIÊN HỆ</h2>
                ...
                <div className={styles.question}>
                    <div className={styles.item}>
                        ...
                        <p>Để biết thông tin và được hỗ trợ với các câu hỏi về kEYCAP, vui lòng truy cập<a className={styles.title} href="https://www.facebook.com/10keycery">10keycery.com</a></p>
                    </div>
                </div>
                    <div className={styles.item}>
